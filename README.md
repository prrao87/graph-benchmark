...
| Query | neo4j-2025.12.1 (ms) | kuzu-0.11.3 (ms) | ladybug-0.14.1 (ms) | lance-graph-0.5.3 (ms) |
| --- | --- | --- | --- | --- |
| q1 | 1552.0ms | 138.0ms (11.2x) | 134.8ms (11.5x) | 19.2ms (80.7x) |
| q2 | 395.0ms | 227.9ms (1.7x) | 215.5ms (1.8x) | 42.5ms (9.3x) |
| q3 | 39.1ms | 6.4ms (6.1x) | 6.5ms (6.0x) | 4.7ms (8.3x) |
| q4 | 38.3ms | 9.7ms (3.9x) | 9.8ms (3.9x) | 2.9ms (13.1x) |
| q5 | 7.7ms | 10.6ms (0.7x) | 10.7ms (0.7x) | 2.7ms (2.8x) |
| q6 | 21.2ms | 27.3ms (0.8x) | 27.1ms (0.8x) | 3.3ms (6.4x) |
| q7 | 117.4ms | 11.2ms (10.5x) | 11.5ms (10.2x) | 4.4ms (26.8x) |
| q8 | 2831.2ms | 6.5ms (435.3x) | 6.6ms (428.5x) | 123.4ms (22.9x) |
| q9 | 2986.7ms | 86.1ms (34.7x) | 87.7ms (34.1x) | 110.8ms (27.0x) |
